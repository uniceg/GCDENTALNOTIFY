...
if (!isset($_SESSION['otp_data'])) {
    echo "<script>alert('OTP session expired.');window.location.href='login.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Verify OTP | Medical Clinic Notify+</title>
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = result.redirect || 'studentHome.php';
                        }, 1200);
                    } else {
